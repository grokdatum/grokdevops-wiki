...
/dev/sda1       50000000 30000000  20000000  60% /"
    ...
    # Fixed Bug 1: Use $5 for Use% column
    local usage=$(echo "$df_output" | tail -1 | awk '{print $5}' | tr -d '%')
...
check_memory() {
    ...
    # Fixed Bug 2: Correct percentage calculation: (used * 100) / total
...
check_services() {
    ...
    for svc in $services; do
        ...
        # Bug 3 is actually correct - detecting stopped services
        # The = operator correctly identifies stopped services
